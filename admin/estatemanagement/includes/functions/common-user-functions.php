				...
				switch ($key) {
					...
					case 'plan':
						if ($value == 1) {
							...
							update_post_meta( $params['order_id'], 'pointfinder_order_expiredate', 3000000000 );
	...
	*/
	...
	if (!function_exists('pointfinder_membership_create_order')) {
        ...
        */
				...
				update_post_meta( $order_post_id, 'pointfinder_order_expiredate', 3000000000);
				update_post_meta( $order_post_id, 'pointfinder_order_datetime_approval', strtotime("now"));
