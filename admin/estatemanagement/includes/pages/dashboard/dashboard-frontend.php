      ...
      $setup4_membersettings_dashboard = PFSAIssetControl('setup4_membersettings_dashboard','','');
			...
			**/ 
				...
				if ($params['formtype'] == 'myitems') {
					...
					$this->FieldOutput .= '<form id="pfuaprofileform" enctype="multipart/form-data" name="pfuaprofileform" method="GET" action="'.$setup4_membersettings_dashboard_link.$pfmenu_perout.'ua=myitems"><input type="hidden" value="myitems" name="ua">';
				}else{
        ...
        ***/
              ...
              /***
              debut update occasionfranchise
              ...
              ***/
                ...
                */
                    ...
                    // Occasion Franchise
                    $registered_user_address = get_user_meta($user_idx,'user_address',true);
                    if(empty($registered_user_address)){
                      $this->FieldOutput .= '<div style="padding:20px; background: rgba(255,184,0,0.33);margin-bottom:15px">
                                                <p>'.__('Please note that if you want to see <strong>your address on the invoice</strong>, please fill it in <a href="/dashboard/?ua=profile"><strong>your profile page</strong></a>.','pointfindert2d').'</p>
                                              </div>';
                    }
                    ...
                    if ( $membership_query->have_posts() ) {
                      $this->FieldOutput .= '<ul class="pf-membership-package-list pf-row">';
                      ...
                      while ( $membership_query->have_posts() ) {
                        ...
                        if ($packageinfo['webbupointfinder_mp_showhide'] == 1) {
                          $icone_forfait = '';
                          $icone_couleur = '';
                          $prix_forfait = ''; //$packageinfo['packageinfo_priceoutput_bfvat_text']
                          $nbr_annonce_forfait = ''; //$packageinfo['packageinfo_itemnumber_output_text']
                          switch($packageinfo['webbupointfinder_mp_packageid']){
                            case 5016:
                              //$icone_forfait = 'pfadmicon-glyph-109';
                              $icone_forfait = 'Defaults-home';
                              $icone_couleur = '#82C250';
                              $prix_forfait = sprintf(esc_html__( '%s$ +tx', 'pointfindert2d' ), '90');
                              $nbr_annonce_forfait = "3 crédits = 3 annonces <br>&nbsp;";
                              $txt = '<p style="text-align: left;"><span dir="ltr" role="presentation"><span style="color: #00ff00;">✔</span> Votre annonce est affichée </span><span dir="ltr" role="presentation">sur tous nos réseaux sociaux.</span></p>
                                      <p style="text-align: left;"><span dir="ltr" role="presentation"><span style="color: #00ff00;">✔</span> Votre annonce est envoyée à </span><span dir="ltr" role="presentation">nos abonnés par courriel.</span></p>
                                      <p style="text-align: left;"><span dir="ltr" role="presentation"><span style="color: #00ff00;">✔</span> L’annonce a une durée de 12 </span><span dir="ltr" role="presentation">mois de visibilité.</span></p>';
                              break;
                            case 14659:
                              $icone_forfait = 'Defaults-globe';
                              $icone_couleur = '#c0c0c0';
                              $prix_forfait = sprintf(esc_html__( '%s$ +tx', 'pointfindert2d' ), '250');
                              //$nbr_annonce_forfait = '10 annonces';
                              $nbr_annonce_forfait ="10 crédits = 10 annonces <br>25 $ par annonce";
                              $txt = '<p style="text-align: left;"><span dir="ltr" role="presentation"><span style="color: #00ff00;">✔</span> Votre annonce est affichée </span><span dir="ltr" role="presentation">sur tous nos réseaux sociaux.</span></p>
                                      <p style="text-align: left;"><span dir="ltr" role="presentation"><span style="color: #00ff00;">✔</span> Votre annonce est envoyée à </span><span dir="ltr" role="presentation">nos abonnés par courriel.</span></p>
                                      <p style="text-align: left;"><span dir="ltr" role="presentation"><span style="color: #00ff00;">✔</span> L’annonce a une durée de 12 </span><span dir="ltr" role="presentation">mois de visibilité.</span></p>';
                              break;
                           case 5106:
                              //$icone_forfait = 'pfadmicon-glyph-145';
                              $icone_forfait = 'Defaults-rocket';
                              $icone_couleur = '#ffdb58';
                              $prix_forfait = sprintf(esc_html__( '%s$ +tx', 'pointfindert2d' ), '500');
                              //$nbr_annonce_forfait = '50 annonces';
                              $nbr_annonce_forfait = "25 crédits = 25 annonces <br>20 $ par annonce";
                              $txt = '<p style="text-align: left;"><span dir="ltr" role="presentation"><span style="color: #00ff00;">✔</span> Votre annonce est affichée </span><span dir="ltr" role="presentation">sur tous nos réseaux sociaux.</span></p>
                                      <p style="text-align: left;"><span dir="ltr" role="presentation"><span style="color: #00ff00;">✔</span> Votre annonce est envoyée à </span><span dir="ltr" role="presentation">nos abonnés par courriel.</span></p>
                                      <p style="text-align: left;"><span dir="ltr" role="presentation"><span style="color: #00ff00;">✔</span> L’annonce a une durée de 12 </span><span dir="ltr" role="presentation">mois de visibilité.</span></p>';
                          break;
                          case 16326:
                              //$icone_forfait = 'pfadmicon-glyph-145';
                              $icone_forfait = 'Defaults-flag';
                              $icone_couleur = '#dd5454';
                              $prix_forfait = sprintf(esc_html__( '%s$ +tx', 'pointfindert2d' ), '999');
                              $nbr_annonce_forfait = "60 crédits = 60 annonces <br>16.65 $ par annonce";
                              $txt = '<p style="text-align: left;"><span dir="ltr" role="presentation"><span style="color: #00ff00;">✔</span> Votre annonce est affichée </span><span dir="ltr" role="presentation">sur tous nos réseaux sociaux.</span></p>
                                      <p style="text-align: left;"><span dir="ltr" role="presentation"><span style="color: #00ff00;">✔</span> Votre annonce est envoyée à </span><span dir="ltr" role="presentation">nos abonnés par courriel.</span></p>
                                      <p style="text-align: left;"><span dir="ltr" role="presentation"><span style="color: #00ff00;">✔</span> L’annonce a une durée de 12 </span><span dir="ltr" role="presentation">mois de visibilité.</span></p>';
                          /*break;
                          case 15405:
                              //$icone_forfait = 'pfadmicon-glyph-145';
                              $icone_forfait = 'Defaults-briefcase';
                              $icone_couleur = '#ab3c3c';
                              //$nbr_annonce_forfait = '50 annonces';
                              $msg=("Affichez votre concept dans notre répertoire de franchises");
                              $espace="<div style='height:9px;'></div>";
                              $confirmation="";
                              $direction="https://occasionsaffaires.ca/contactez-nous/";
                              $button='<a href ="'.$direction.'" target="_blank" >Contacter Occasions Affaires</a>';*/
                          }
                          
                          $this->FieldOutput .= '<li class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                  <div class="pf-membership-package-box">';
/*if ($post_id == 5016 || $post_id == 5106 || $post_id == 16326){*/
    $buttonText = esc_html__('Select', 'pointfindert2d');
    $this->FieldOutput .= do_shortcode(
        '[ultimate_info_table design_style="design06" color_scheme="custom" color_bg_highlight="' . $icone_couleur . '" package_heading="' . get_the_title() . '" icon_type="selector" icon="' . $icone_forfait . '" icon_color="' . $icone_couleur . '" heading_font_family="font_family:Open Sans|font_call:Open+Sans" heading_font_size="desktop:20px;" subheading_font_family="font_family:Open Sans|font_call:Open+Sans" features_font_family="font_family:Open Sans|font_call:Open+Sans" button_font_family="font_family:Open Sans|font_call:Open+Sans"]
        <h4 style="margin-top: 5px;"><strong><span style="font-size: 16px; color: #666;">' . $prix_forfait . '</span></strong></h4><br>
         <p style="text-align: center;">' . $nbr_annonce_forfait . '</p><br> <div class="deonly">' . $txt .'</div>


        <div class="pf-membership-splan-button-wrapper">
            <div class="pf-membership-splan-button">
                <a data-id="' . $post_id . '" data-ptype="' . $params['formtype'] . '">' . $buttonText . '</a>
            </div>
        </div>
        [/ultimate_info_table]'
    );
...
else if ($post_id == 14659){
    $buttonText = esc_html__('Select', 'pointfindert2d');
    $this->FieldOutput .= do_shortcode(
        '[ultimate_info_table design_style="design06" color_scheme="custom" color_bg_highlight="' . $icone_couleur . '" package_heading="' . get_the_title() . '" icon_type="selector" icon="' . $icone_forfait . '" icon_color="' . $icone_couleur . '" heading_font_family="font_family:Open Sans|font_call:Open+Sans" heading_font_size="desktop:20px;" subheading_font_family="font_family:Open Sans|font_call:Open+Sans" features_font_family="font_family:Open Sans|font_call:Open+Sans" button_font_family="font_family:Open Sans|font_call:Open+Sans"]
        <h4 style="margin-top: 5px;"><div class="deleted-text"></div></h4>
<span style="color: #ff0000;"><strong>125 $ + tx</strong></span>

<span style="color: #ff0000;">Économisez 50% pour un temps limité *</span>
<p style="text-align: center;" data-pm-slice="1 1 [&quot;orderedList&quot;,{&quot;order&quot;:1},&quot;listItem&quot;,null]">10 crédits = 10 annonces</p>
<p style="text-align: center;" data-pm-slice="1 1 [&quot;orderedList&quot;,{&quot;order&quot;:1},&quot;listItem&quot;,null]">12.5 $ par annonce</p>
<p style="text-align: left;"><span style="color: #00ff00;">✔</span> Votre annonce est affichée sur tous nos réseaux sociaux.</p>
<p style="text-align: left;"><span style="color: #00ff00;">✔</span> Votre annonce est envoyée à nos abonnés par courriel.</p>
<p style="text-align: left;"><span style="color: #00ff00;">✔</span> L’annonce a une durée de 12 mois de visibilité.</p>
'.'
...
// Add JavaScript code to redirect the original page
if ($post_id != 5016) {
    $this->FieldOutput .= '
        <script>
            function redirectOriginalPage() {
    ...
    ';
                    ...
                    if ($setup4_mem_terms == 1) {
                      ...
                      $this->FieldOutput .=   '<div class="unformat-golden-forms" style="padding:20px; background: rgba(255,184,0,0.33);margin-bottom:15px">
                                                <p>'.sprintf(__('As specified in the %s Terms of Use %s : ','pointfindert2d'),'<a href="'.$terms_permalink.$pfmenu_perout.'ajax=true&width=800&height=400" rel="prettyPhoto[ajax]"><strong>','</strong></a>').'</p>
                                                <ul>
                                                  <li>'.sprintf(__('Each ad creation and modification is %s subject to approval %s.','pointfindert2d'), '<span style="text-decoration:underline;">', '</span>').'</li>
                                                  <li>'.__('The following reasons are subject to refusal :','pointfindert2d').'
                                                    <ul>
                                                      <li>'.__('The ad listing is in another language than English.','pointfindert2d').'</li>
                                                      <li>'.__('The ad listing is not related to a franchise, business or real estate sale.','pointfindert2d').'</li>
                                                      <li>'.__('The ad listing is not for a specific location or business, but lists various locations or businesses within a single ad.  If you wish to list several properties or businesses, please create individual ads for each one.','pointfindert2d').'</li>
                                                      <li>'.__('The ad listing is for a new franchise, instead of an existing franchise for resale.','pointfindert2d').'</li>
                                                      <li>'.__('The ad listing is incomplete, e.g. missing contact information, investment amount, location, etc.','pointfindert2d').'</li>
                                                    </ul>
                                                  </li>
                                                  <li>'.__('A rejected ad only results in the refund of the used ad credit (no cash refund).','pointfindert2d').'</li>
                                                </ul>
                                              </div>
                                              ...
                                              <span class="goption upt">
                                                ...
                                                <label for="pftermsofuser">'.sprintf(esc_html__( 'I have read the %s Terms of Use %s and accept them.', 'pointfindert2d' ),'<a href="'.$terms_permalink.$pfmenu_perout.'ajax=true&width=800&height=400" rel="prettyPhoto[ajax]"><strong>','</strong></a>').'</label>
                                              </span>
                                            </section>';
                    }
										//**
                ...
                ***/
							...
							if ($main_submit_permission) {
                              ...
                              $thispost_thumbnail = get_post_meta($params['post_id'],'_thumbnail_id');
															$featuredimagenum = get_post_thumbnail_id($params['post_id']);

															$images_count = count($images_of_thispost) + count($thispost_thumbnail);
                              ...
                              $setup4_submitpage_imagesizelimit = PFSAIssetControl('setup4_submitpage_imagesizelimit','','2');/*Image size limit*/
															...
															if ($params['formtype'] != 'edititem' || $images_count < 1) {
                    ...
                    /*
										...
										//**
											...
											if ($featured_permission) {
												if ($setup4_membersettings_paymentsystem != 2) {
													...
													$this->FieldOutput .= '
                            <section class="pfsubmit-inner pfsubmit-inner-nopadding">';
                          ...
                          if($package_featuredcheck == 1 && $current_post_status != 'pendingpayment'){
                            $this->FieldOutput .='
                                  <input type="hidden" name="featureditembox" id="featureditembox">';
                          }else{
                    ...
                    */
					...
					case 'profile':
						...
						**/
								...
								if(!isset($usermetaarr['company'])){$usermetaarr['company'][0] = '';}
								...
								if(!isset($usermetaarr['user_postalcode'])){$usermetaarr['user_postalcode'][0] = '';}
								...
								$this->FieldOutput .= '<div class="col6 first">
                                        <section>
                                          <label for="nickname" class="lbl-text"><strong>'.esc_html__('Nickname (Display Name)','pointfindert2d').'</strong><span style="font-size:12px;" class="gfield_required">*</span>:</label>
                                          <label class="lbl-ui">
                                            <input type="text" name="nickname" class="input" value="'.$usermetaarr['nickname'][0].'" />
                                          </label>
                                        </section>
                                        <section>
                                          <label for="email" class="lbl-text"><strong>'.esc_html__('Email Address','pointfindert2d').'</strong><span style="font-size:12px;" class="gfield_required">*</span>:</label>
                                          <label class="lbl-ui">
                                        ...
                                        <section>
                                          ...
                                          <div class="col-lg-3">
                                            <div class="pfuserphoto-container">'.$usermetaarr['user_photo'][0].'</div>
                                          </div>
                                          <div class="col-lg-9">
                                   ...
                                   <div class="col6 last">
                                      <section>
                                        <label for="company" class="lbl-text">'.esc_html__('Company name','pointfindert2d').':</label>
                                        <label class="lbl-ui">
                                          <input type="text" name="company" class="input" value="'.$usermetaarr['company'][0].'" />
                                        </label>
                                      </section>
                                      <section>
                                      ...
                                      $this->FieldOutput .= '
                                      <section>
                                        <label for="postalcode" class="lbl-text">'.esc_html__('Postal Code','pointfindert2d').':</label>
                                        <label class="lbl-ui">
                                          <input type="text" name="postalcode" class="input" value="'.$usermetaarr['user_postalcode'][0].'"/>
                                        </label>
                                      </section>';
                                      if (!empty($stp_prf_country)) {
                                        $this->FieldOutput .= '
                                        <section>
                                            <label for="country" class="lbl-text">'.esc_html__('Province','pointfindert2d').':</label>
                                            <label class="lbl-ui">
              ...
              $membership_user_item_limit = get_user_meta( $user_id, 'membership_user_item_limit', true );
                        ...
                        <section>
                          <div class="row">
                            <div class="col1-5 first">
                              <label for="listing-filter-status" class="lbl-ui select">
                                <select id="listing-filter-status" name="listing-filter-status">';
                                  ...
                                  $this->FieldOutput .= ($selected_lfs == 'editimage') ? '<option value="editimage" selected>'.esc_html__('Edit Image','pointfindert2d').'</option>' : '<option value="editimage">'.esc_html__('Edit Image','pointfindert2d').'</option>';
                                  $this->FieldOutput .= ($selected_lfs == 'editdesc') ? '<option value="editdesc" selected>'.esc_html__('Edit Description','pointfindert2d').'</option>' : '<option value="editdesc">'.esc_html__('Edit Description','pointfindert2d').'</option>';
                                  $this->FieldOutput .= ($selected_lfs == 'editprice') ? '<option value="editprice" selected>'.esc_html__('Edit Additional Information (Price, etc.)','pointfindert2d').'</option>' : '<option value="editprice">'.esc_html__('Edit Additional Information (Price, etc.)','pointfindert2d').'</option>';
                                  $this->FieldOutput .= ($selected_lfs == 'editadr') ? '<option value="editadr" selected>'.esc_html__('Edit Address','pointfindert2d').'</option>' : '<option value="editadr">'.esc_html__('Edit Address','pointfindert2d').'</option>';
                                  $this->FieldOutput .= ($selected_lfs == 'edittag') ? '<option value="edittag" selected>'.esc_html__('Edit Tag','pointfindert2d').'</option>' : '<option value="edittag">'.esc_html__('Edit Tag','pointfindert2d').'</option>';
                                  $this->FieldOutput .= ($selected_lfs == 'editatchm') ? '<option value="editatchm" selected>'.esc_html__('Edit Attachment','pointfindert2d').'</option>' : '<option value="editatchm">'.esc_html__('Edit Attachment','pointfindert2d').'</option>';
                                  $this->FieldOutput .= '
                                </select>
                              </label>
                            </div>
                            <div class="col1-5 first">
                              <label for="listing-filter-ltype" class="lbl-ui select">
                      ...
                      $this->FieldOutput .= '
													...
													switch ($status_of_post) {
														case 'pendingpayment':
															if ($status_of_order == 'pfsuspended') {
																...
																if ($setup4_membersettings_paymentsystem == 2) {
																	$status_text = esc_html__('Expired','pointfindert2d');
                                  ...
                                  $status_lbl = 'lblpending';
														...
														case 'rejected':
															...
															$status_payment = 1;
															$status_icon = 'pfadmicon-glyph-96';
															$status_lbl = 'lblcancel';
															break;
                            
                            case 'editimage':
															$status_text = esc_html__('Please, edit image','pointfindert2d');
															$status_payment = 1;
															$status_icon = 'pfadmicon-glyph-75';
															$status_lbl = 'lblpending';
															break;

														case 'editdesc':
															$status_text = esc_html__('Please, edit description','pointfindert2d');
															$status_payment = 1;
															$status_icon = 'pfadmicon-glyph-75';
															$status_lbl = 'lblpending';
															break;
														...
														case 'editprice':
															$status_text = esc_html__('Please, edit Additional Information section','pointfindert2d');
															$status_payment = 1;
															$status_icon = 'pfadmicon-glyph-75';
															$status_lbl = 'lblpending';
															break;
														...
														case 'editadr':
															$status_text = esc_html__('Please, edit address','pointfindert2d');
															$status_payment = 1;
															$status_icon = 'pfadmicon-glyph-75';
															$status_lbl = 'lblpending';
															break;
														...
														case 'edittag':
															$status_text = esc_html__('Please, edit tags','pointfindert2d');
															$status_payment = 1;
															$status_icon = 'pfadmicon-glyph-75';
															$status_lbl = 'lblpending';
															break;
														...
														case 'editatchm':
															$status_text = esc_html__('Please, edit attachment file','pointfindert2d');
															$status_payment = 1;
															$status_icon = 'pfadmicon-glyph-75';
															$status_lbl = 'lblpending';
															break;
														...
														case 'publish':
															...
															$status_payment = 1;
															$status_icon = 'pfadmicon-glyph-95';
                          ...
                          $this->FieldOutput .= '<div class="pfmu-itemlisting-inner pfmu-itemlisting-inner'.$author_post_id.' pf-row clearfix">';
                                ...
                                $this->FieldOutput .= '<img src="'.get_stylesheet_directory_uri().'/images/noimg_mini.png'.'" alt="" />';
															}
														$this->FieldOutput .= '</div>';
                            ...
                            if($permalink_item == '#'){
                              ...
                              $this->FieldOutput .= '<a href="'.$permalink_item.'">'.get_the_title().'</a>';
                                                    ...
                                                    <ul class="pfiteminfolist" style="padding-left:10px">
                                                      <li>'.get_the_term_list( $author_post_id, 'pointfinderltypes', '<ul class="pointfinderpflistterms"><li>', ',</li><li>', '</li></ul>' ).'</li>
                                                    </ul>
                                                  </div>';
                            ...
                            //$this->FieldOutput .= '<h3> PF_UserLimit_Check: '.$this->PF_UserLimit_Check('edit',$status_of_post).'</h3>';
                            /*
                            $status_of_order = "completed"
                            $status_of_post = "pendingpayment"
                            $this->PF_UserLimit_Check('edit',$status_of_post) = 1
                            */
                            if(
                                (
                                  $this->PF_UserLimit_Check('edit',$status_of_post) == 1
                                  &&
                                  $status_of_order != 'pfsuspended'
                                )
                                ||
                                (
                                  $this->PF_UserLimit_Check('edit',$status_of_post) == 1
                                  &&
                                  $status_of_post == 'pfonoff'
                                )
                              ) {
                                  ...
                                  // occasionfranchise
                                  (
                                    $setup4_membersettings_paymentsystem == 2 // membership
                                    &&
                                    $status_of_post == 'pendingpayment'
                                    &&
                                    $membership_user_item_limit <= 0
                                  )
                                  ||
                                  (
                                    $setup4_membersettings_paymentsystem == 2 // membership
                          ...
                          // occasionfranchise
                            ...
                            $this->FieldOutput .= '<div class="col-lg-1 col-md-1 col-sm-2 hidden-xs"></div>';
                            $this->FieldOutput .= '<div class="col-lg-11 col-md-11 col-sm-10 col-xs-12"><div class="pfmu-itemlisting-info pffirst"><ul class="pfiteminfolist"><li>';
                            $membership_user_item_limit = get_user_meta( $user_id, 'membership_user_item_limit', true );
                            if($membership_user_item_limit > 0){
                              $this->FieldOutput .= '<span class="pfiteminfolist-infotext" style="color:#4286f4;"><i class="pfadmicon-glyph-637"></i> '.esc_html__('To renew your ad, publish it again on the edit page.','pointfindert2d').'</span>';
                            }else{
                              $this->FieldOutput .= '<span class="pfiteminfolist-infotext lblpending"><i class="pfadmicon-glyph-637"></i> '.esc_html__('To renew your ad, make sure you have available credit first.','pointfindert2d').'</span>';
                            }
                            $this->FieldOutput .= '</li></ul></div></div>';
                          }
													...
													<ul>';
														...
														if(!in_array($status_of_post, array('pendingapproval','pendingpayment','rejected','editimage','editdesc','editprice','editadr','edittag','editatchm'))) {
															$this->FieldOutput .= '<li>
                                                      <span data-pfid="'.$author_post_id.'" class="pfiteminfolist-title pfstatus-title '.$onoff_text.' pfstatusbuttonaction" title="'.$onoff_word.'" data-pf-deactive="'.esc_html__("Your listing is deactive","pointfindert2d" ).'" data-pf-active="'.esc_html__("Your listing is active","pointfindert2d" ).'"><i class="pfadmicon-glyph-348"></i></span>
                                                    </li>';
														}
										...
										if (PFControlEmptyArr($fieldvars)) {
											$this->FieldOutput .= '<strong>'.esc_html__('No record found!','pointfindert2d').'</strong><br>'.__('Please refine your search criteria and try to check again. Or you can press <strong>Reset</strong> button to see all items.','pointfindert2d').'</p></div>';
										}else{
					...
					case 'favorites':
						...
						**/
                            ...
                            $this->FieldOutput .= '</div>';
										...
										$this->FieldOutput .= '<div class="notification warning" id="pfuaprofileform-notify-warning"><p>';
										if (PFControlEmptyArr($fieldvars)) {
											$this->FieldOutput .= '<strong>'.esc_html__('No record found!','pointfindert2d').'</strong><br>'.__('Please refine your search criteria and try to check again. Or you can press <strong>Reset</strong> button to see all.','pointfindert2d').'</p></div>';
										}else{
					...
					case 'invoices':
								...
								$this->FieldOutput .= '<div class="pfmu-itemlisting-container">';
									...
									*/
									...
									if ( $output_loop->have_posts() ) {
										...
										$setup4_membersettings_paymentsystem = PFSAIssetControl('setup4_membersettings_paymentsystem','','1');
										$paypal_price_unit = PFSAIssetControl('setup20_paypalsettings_paypal_price_unit','','CAD');
										...
										**/
											$this->FieldOutput .= '<div class="pfmu-itemlisting-htitle pfexhtitle col-lg-2 col-md-2 col-sm-2 hidden-xs">'.
                                            esc_html__('View','pointfindert2d').
                                            ' / '.
                                            esc_html__('Print','pointfindert2d').
                                            '</div>';
											
											$this->FieldOutput .= '<div class="pfmu-itemlisting-htitle pfexhtitle col-lg-3 col-md-3 col-sm-3 hidden-xs">';
											$this->FieldOutput .= esc_html__('Plan','pointfindert2d');
											$this->FieldOutput .= '</div>';
                      ...
                      $price_val_inv = pointfinder_reformat_pricevalue_for_frontend($price_val_inv);
                      ...
                      $this->FieldOutput .= '<div class="pfmu-itemlisting-inner pf-row clearfix">';
                        ...
                        $this->FieldOutput .= '<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 pfmu-itemlisting-title-wd">';
                          $this->FieldOutput .= '<div class="pfmu-itemlisting-title pf-review-list">';
                            $this->FieldOutput .= '<a href="'.get_permalink().'" style="font-weight:bold" target="_blank" ><i class="pfadmicon-glyph-388"></i> '.$inv_prefix.$author_post_id.'</a>';
                          $this->FieldOutput .= '</div>';
                        $this->FieldOutput .= '</div>';
			...
			**/
				...
				if(
          $params['formtype'] != 'myitems'
          &&
          $params['formtype'] != 'favorites'
          &&
          $params['formtype'] != 'reviews'
        ){
          $xtext = '';
        }else{
          $xtext = 'style="background:transparent;background-color:transparent;display:none!important"';
        }
            ...
            $params['formtype'] != 'reviews'
            &&
            $params['formtype'] != 'invoices'
            &&
            $params['dontshowpage'] != 1
            &&
            $main_package_expire_problem != true
            ){
            $this->FieldOutput .='<section '.$xtext.'> ';
