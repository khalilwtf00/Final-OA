<?php
add_shortcode( 'pf_pfitemcarousel', 'pf_pfitemcarousel_func_child' );

function pf_pfitemcarousel_func_child( $atts ) {
            ...
            <div class="'.$pfgridcol_output.' wpfitemlistdata">
              ...
              <div class="pflist-item-inner">
                ...
                if($setup22_searchresults_hover_image == 1){
                  ...
                  $targetforitem = ''; // Define $targetforitem and initialize it with an empty string
                    $wpflistdata_output .= "<a href='" . $ItemDetailArr['if_link'] . "'" . $targetforitem . ">";
                  if ($general_crop2 == 3) {
                ...
                */
                ...
                <div class="pflist-detailcontainer pflist-subitem">
                  <ul class="pflist-itemdetails">
                    <li class="pflist-itemtitle"><a href="'.$ItemDetailArr['if_link'].'">'.$ItemDetailArr['if_title'].'</a></li>
                    ';
                    ...
                    if ($st22srloc == 1) {
                      ...
                      if($post_listing_typeval == 52){
                        $showRegionLink = TRUE;
                      }
                      $location_val = GetPFTermInfoH( $pfitemid, 'pointfinderlocations', '', 2, $showRegionLink);
                      if (!empty($location_val)) {
                        $wpflistdata_output .= '<li class="pflist-location"><i class="pfadmicon-glyph-787"></i> '.$location_val.'</li>';
                      }
                    }
