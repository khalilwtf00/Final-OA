<?php
add_shortcode( 'pf_searchw', 'pf_searchw_func_child' );
function pf_searchw_func_child( $atts ) {
	...
	**/  
        ...
        if(!wp_script_is('pfsearch-select2-js', 'enqueued')){wp_enqueue_script('pfsearch-select2-js');}    
          ...
          **/
          ...
          <div class="pointfinder-mini-search" style="text-align:right;">
            <div class="pf-row">
              <div class="col-lg-12 col-md-12 col-sm-12 colhorsearch">
                <a style="padding: 15px 0px;font-size:14px;color: white;font-weight: bold;text-transform: uppercase;display:inline-block;" href="<?php echo get_permalink(6330); ?>" title="<?php echo __('Use advanced options to refine your search','pointfindert2d'); ?>"><?php echo __('Advanced Search','pointfindert2d'); ?> <i class="pfadmicon-glyph-716"></i></a>
              </div>
            </div>
          </div>
          <?php
