<?php
add_shortcode( 'pf_salist_widget', 'pf_salist_widget_func' );
function pf_salist_widget_func( $atts ) {
	...
	$listing_meta = get_option('pointfindercondition_vars');
		    ...
		    foreach ( $listing_terms as $term ) {
		        if ($term->parent == 0) {
		        	...
		        	if (isset($listing_meta[$term->term_id])) {
		        		...
		        		$this_term_catbg = (isset($listing_meta[$term->term_id]['pf_condition_bg']))? $listing_meta[$term->term_id]['pf_condition_bg']:'#ededed';
		        		$this_term_cattext = (isset($listing_meta[$term->term_id]['pf_condition_text']))? $listing_meta[$term->term_id]['pf_condition_text']:'#494949';
